        ...
        <DndContext sensors={sensors} onDragStart={onDragStart} onDragOver={onDragOver} onDragEnd={onDragEnd} onDragCancel={() => {
            ...
            >
                ...
                <div className="p-3 space-y-3">
                    {pushes.length === 0 && (
                        <div className="flex flex-col items-center justify-center h-[50vh] text-muted-foreground border-2 border-dashed rounded-xl m-3 bg-muted/10">
                                        ...
                                        <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
                                                ...
                                                {showMarkCompleteAction ? (
                                                    ...
                                                    <div
                                                        className={cn(
                                                            ...
                                                            !isComplete && push.taskCount > 0 ? "opacity-100" : "opacity-0 pointer-events-none"
                                                        )}
                                                    >
                                            ...
                                            >
                                                <span className={cn(
                                                    ...
                                                    isComplete ? "text-muted-foreground/55" : "text-muted-foreground"
                                                )}>
                                                    {pushDateLabel}
                                                </span>
                                            </div>
